            ...
            <aside className="w-full lg:w-1/4">
              <div className="glass-card p-6 sticky top-24">
                <nav className="space-y-2">
                  <Link to="/settings/profile" className="flex items-center gap-3 px-4 py-3 rounded-lg text-warm-100 bg-warm-800/50 hover:bg-warm-800/70 transition-colors">
                  ...
                  <Link to="/settings/portfolio" className="flex items-center gap-3 px-4 py-3 rounded-lg text-warm-300 hover:bg-warm-800/30 transition-colors">
                  ...
                  <Link to="/settings/account" className="flex items-center gap-3 px-4 py-3 rounded-lg text-warm-300 hover:bg-warm-800/30 transition-colors">
